...
//        photosViewController.store = PhotoStore()
    ...
    func applicationDidBecomeActive(application: UIApplication) {
        // Resplasht any tasks that were paused (or not yet splashted) while the application was inactive. If the application was previously in the background, optionally refresh the user interface.
    }
